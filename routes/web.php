...
Route::middleware(['web', 'guest'])->group(function () {
    // Simple public registration (servant chooses service group)
    ...
    Route::post('/register', [RegistrationController::class, 'storePublic'])
        ...
        ->middleware('throttle:100,1'); // 100 attempts per minute for development

    // Token-based registration (for specific service groups)
