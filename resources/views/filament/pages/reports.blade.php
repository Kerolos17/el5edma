<x-filament-panels::page>
    <div class="space-y-6">
        ...
        {{-- فلاتر --}}
        <div
            class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {{-- تقرير المخدومين --}}
            <div class="p-5 bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <div class="flex gap-2">
                    <button wire:click="exportBeneficiariesExcel"
                        class="flex-1 px-3 py-2 bg-green-600 text-white text-xs font-medium rounded-lg hover:bg-green-700 transition">
                        📊 Excel
                    </button>
                    <a href="{{ $this->getBeneficiariesPdfUrl() }}" target="_blank"
                        class="flex-1 px-3 py-2 bg-red-600 text-white text-xs font-medium rounded-lg hover:bg-red-700 transition text-center">
                        📄 PDF
                    </a>
                </div>
            </div>
